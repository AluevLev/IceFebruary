namespace IceFebruary.Space.Vector2Provider
{
    ...
    /// <summary>
    /// Vector provider that maps a vector from the screen to a vector in the world.
    /// </summary>
    public sealed class ScreenToWorldVector2Provider : IVector2Provider
    {
        ...
        /// <summary>
        /// Creates a new vector provider that maps a vector from the screen to a vector in the world.
        /// </summary>
        ...
        /// <summary>
        /// Returns the vector mapped from the screen to the world.
        /// </summary>
